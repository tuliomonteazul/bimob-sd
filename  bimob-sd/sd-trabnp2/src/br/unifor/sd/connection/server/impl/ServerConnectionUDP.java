...
//
//	private static ServerConnectionUDP instance;
//	
...
//	}
//	
//	public static ServerConnectionUDP getInstance() {
//		if (instance == null) {
...
//		try {
//			System.out.println("enviando para o cliente: "+cliente.getPort());
//			final Socket socket = new Socket(cliente.getAddress(), cliente.getPort());
//			
